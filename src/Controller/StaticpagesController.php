...
class StaticpagesController extends AppController
{
	...
	public function beforeFilter(Event $event) {  
        ...
        $this->Auth->allow(['view','faq','contact','term','promoteproduct','aboutus','becomeaseller','sellingproducts','privacy']);      
        $this->authcontent();    
    }
    ...
    public function index() 
    {
       ...
       // $staticpages = $this->Staticpages->find('all',['conditions'=>['Staticpages.position !='=>'faq','Staticpages.status'=>1]]);
