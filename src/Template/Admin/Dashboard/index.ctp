...
<section class="content">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo count($videos); ?></span>
                </div>
              </a>  
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <ul class="users-list clearfix">
                        ...
                        <li>
                        	<?php if($member['image'] != ''){ ?>
                            <img src="<?php echo $member['image']; ?>" alt="<?php echo $member['name']; ?>" style="height: 112px;">
                            <?php }else{ ?>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Latest Video Category</h3>
                </div>
