<section class="content-header">
   ...
   <?= __('Video') ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?= __('Edit Video') ?></li>
    </ol>
</section>
	...
	<div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?= __('Edit Video') ?><strong>(ID: <?php echo $videos->id; ?>)</strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?= $this->Form->create($videos, ['id' => 'product-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="status" class="form-control">
                    <option value="1" <?php if($videos->status==1){ echo "selected"; }?>>Active</option>
                    <option value="0" <?php if($videos->status==0){ echo "selected"; }?>>Deactive</option>
                ...
                <div class="form-group">
                  ...
                  <?php echo $this->Form->control('poster', ['id' => 'productPic', 'type' => 'file', 'class' => 'form-control', 'label' => false]); ?>
                </div>   
                <img src="<?php echo $this->request->webroot; ?>images/videos/<?php echo ($videos->poster != '') ? $videos->poster : 'no-image.jpg' ?>" class="previewHolder" style="width: 135px;"/>             
              </div>
