<section class="content-header">
    <h1>
    <?php if($staticpage->position =='faq'){ echo "Faq"; }else{ echo "Static Pages";  } ?>
    <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit <?php if($staticpage->position =='faq'){ echo "Faq"; }else{ echo "Static Pages";  } ?></li>
    </ol>
</section>
	...
	<div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit <?php if($staticpage->position =='faq'){ echo "Faq"; }else{ echo "Static Pages";  } ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
