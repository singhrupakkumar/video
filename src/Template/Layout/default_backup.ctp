 ...
 <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                ...
                <ul>
                    ...
                    <?php }else{ ?>
                    <li class="<?php  if($this->request->params['action'] == 'myaccount' ) { echo "active"; }?>"><a class="" href="<?php echo $this->request->webroot ?>users/myaccount"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a>
                        <ul>
